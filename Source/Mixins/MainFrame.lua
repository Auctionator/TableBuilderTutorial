...
function TableBuilderTutorialMixin:OnDragStart()
  self:StartMoving()
end

function TableBuilderTutorialMixin:OnDragStop()
...
function TableBuilderTutorialMixin:InitializeTable()
  ...
  column:ConstructHeader("BUTTON", "TBTColumnHeaderTemplate", "Animal", "Names of animals generated by Mockaroo", 1)
  ...
  column:ConstructCells("FRAME", "TBTTextCellTemplate", 1)

  column = self.tableBuilder:AddColumn()
  column:ConstructHeader("BUTTON", "TBTColumnHeaderTemplate", "Scientific", "Scientific names of animals generated by Mockaroo", 2)
  column:ConstrainToHeader()
  column:ConstructCells("FRAME", "TBTTextCellTemplate", 2)

  column = self.tableBuilder:AddColumn()
  column:ConstructHeader("BUTTON", "TBTColumnHeaderTemplate", "Buzzword", "Random buzzword generated by Mockaroo", 3)
  column:ConstrainToHeader()
  column:ConstructCells("FRAME", "TBTTextCellTemplate", 3)
